...
def start(message):
    text =  f'{message.from_user.first_name}, Вас приветствует Бот-Конвертер валют, и я могу:  \n- Показать список доступных валют через команду /values ; \
...
def help(message: telebot.types.Message):
    text = 'Чтобы начать конвертацию, введите команду боту через пробел в следующем формате:' \
